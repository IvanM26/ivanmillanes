...
```{r}
# Function to create a kable table with a dataset head()
...
```{r head-data, cache=TRUE}
kable_head(title.basics)
kable_head(title.ratings)
kable_head(title.crew, 8)
kable_head(name.basics)
```
