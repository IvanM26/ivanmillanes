...
`rvest` is a great tool to scrape data from static web pages (check out [Creating a Movies Dataset](https://ivanmillanes.netlify.app/post/movie-dataset-with-r/) to see an example!).
